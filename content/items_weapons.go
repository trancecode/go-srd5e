...
func Weapons() []Item {
	return []Item{
		...
		weapon("maul", "Maul", WeaponCategoryMartial, core.Gp(10), 10, "2d6", core.Bludgeoning, PropertyTwoHanded),
		weapon("morningstar", "Morningstar", WeaponCategoryMartial, core.Gp(15), 4, "1d8", core.Piercing),
		weapon("pike", "Pike", WeaponCategoryMartial, core.Gp(5), 18, "1d10", core.Piercing, PropertyReach, PropertyTwoHanded),
		...
		weapon("shortsword", "Shortsword", WeaponCategoryMartial, core.Gp(10), 2, "1d6", core.Slashing, PropertyFinesse, PropertyLight),
		weapon("trident", "Trident", WeaponCategoryMartial, core.Gp(5), 4, "1d6", core.Piercing, PropertyTwoHanded, PropertyThrown, PropertyVersatile).ranged(20, 60).versatile("1d8"),
		...
		weapon("whip", "Whip", WeaponCategoryMartial, core.Gp(2), 3, "1d4", core.Slashing, PropertyReach),
