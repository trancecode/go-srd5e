...
// order (light, medium, heavy, then the shield). Every field is pinned to
// content/testdata/srd-2014-armor.json, generated by
// content/testdata/fetch-srd-2014.py armor: AC, Dex cap, Strength
// requirement, stealth and cost come from Open5e's v1 API
// (api.open5e.com/v1/armor/?document__slug=wotc-srd), which carries no
// weight; weight comes from Open5e's v2 API (api.open5e.com/v2/items/,
// filtered to document key "srd-2014"), hand-checked against the SRD 5.1
// armour table.
func Armor() []Item {
	return []Item{
		// Light armor.
